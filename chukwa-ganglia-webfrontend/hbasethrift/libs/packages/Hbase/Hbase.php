...
interface HbaseIf {
  ...
  public function scannerOpenWithScan($tableName, $scan, $attributes);
...
class HbaseClient implements HbaseIf {
  ...
  public function send_scannerOpenWithScan($tableName, $scan, $attributes)
  {
  ...
  public function write($output) {
    ...
    if ($this->attributes !== null) {
      ...
      $xfer += $output->writeFieldBegin('attributes', TType::MAP, 4);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->attributes));
        {
          foreach ($this->attributes as $kiter383 => $viter384)
          {
        ...
        case 3:
          if ($ftype == TType::MAP) {
            ...
            for ($_i389 = 0; $_i389 < $_size385; ++$_i389)
            {
              ...
              $xfer += $input->readString($val391);
              $this->attributes[$key390] = $val391;
            }
            $xfer += $input->readMapEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->attributes !== null) {
      ...
      $xfer += $output->writeFieldBegin('attributes', TType::MAP, 3);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->attributes));
        {
          foreach ($this->attributes as $kiter392 => $viter393)
          {
            $xfer += $output->writeString($kiter392);
            $xfer += $output->writeString($viter393);
          }
        }
        $output->writeMapEnd();
      }
  ...
  public function write($output) {
    ...
    if ($this->columns !== null) {
      ...
      $xfer += $output->writeFieldBegin('columns', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRING, count($this->columns));
        {
          foreach ($this->columns as $iter407)
          {
    ...
    if ($this->attributes !== null) {
      ...
      $xfer += $output->writeFieldBegin('attributes', TType::MAP, 4);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->attributes));
        {
          foreach ($this->attributes as $kiter408 => $viter409)
          {
            $xfer += $output->writeString($kiter408);
            $xfer += $output->writeString($viter409);
          }
        }
        $output->writeMapEnd();
      }
  ...
  public function write($output) {
    ...
    if ($this->columns !== null) {
      ...
      $xfer += $output->writeFieldBegin('columns', TType::LST, 4);
      {
        $output->writeListBegin(TType::STRING, count($this->columns));
        {
          foreach ($this->columns as $iter423)
          {
    ...
    if ($this->attributes !== null) {
      ...
      $xfer += $output->writeFieldBegin('attributes', TType::MAP, 5);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->attributes));
        {
          foreach ($this->attributes as $kiter424 => $viter425)
          {
            $xfer += $output->writeString($kiter424);
            $xfer += $output->writeString($viter425);
          }
        }
        $output->writeMapEnd();
      }
  ...
  public function write($output) {
    ...
    if ($this->columns !== null) {
      ...
      $xfer += $output->writeFieldBegin('columns', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRING, count($this->columns));
        {
          foreach ($this->columns as $iter439)
          {
    ...
    if ($this->attributes !== null) {
      ...
      $xfer += $output->writeFieldBegin('attributes', TType::MAP, 4);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->attributes));
        {
          foreach ($this->attributes as $kiter440 => $viter441)
          {
        ...
        case 5:
          if ($ftype == TType::MAP) {
            ...
            for ($_i452 = 0; $_i452 < $_size448; ++$_i452)
            {
              $key453 = '';
              $val454 = '';
              $xfer += $input->readString($key453);
              $xfer += $input->readString($val454);
              $this->attributes[$key453] = $val454;
            }
            $xfer += $input->readMapEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->columns !== null) {
      ...
      $xfer += $output->writeFieldBegin('columns', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRING, count($this->columns));
        {
          foreach ($this->columns as $iter455)
          {
    ...
    if ($this->attributes !== null) {
      ...
      $xfer += $output->writeFieldBegin('attributes', TType::MAP, 5);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->attributes));
        {
          foreach ($this->attributes as $kiter456 => $viter457)
          {
            $xfer += $output->writeString($kiter456);
            $xfer += $output->writeString($viter457);
          }
        }
        $output->writeMapEnd();
      }
