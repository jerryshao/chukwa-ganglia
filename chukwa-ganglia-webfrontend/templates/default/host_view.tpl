...
<A HREF="./graph.php?g=disk_report&z=large&c={cluster_url}&{graphargs}">
<IMG BORDER=0 ALT="{cluster_url} DISK"
   SRC="./graph.php?g=disk_report&z=medium&c={cluster_url}&{graphargs}">
</A>
